...
@DatabaseView(
        ...
        value = "SELECT r.receptionId, r.tempReceptionId, r.ica, " +
                ...
                "r.isFarmEnabled, pc.contractCode, pc.description, r.supplierId, r.containerReceptionMappingId, r.isClosed, r.closedDate " +
                ...
                "LEFT JOIN purchase_contracts pc ON pc.contractId = r.purchaseContract " +
                "LEFT JOIN reception_summary ds ON ds.tempReceptionId = r.tempReceptionId " +
                "WHERE r.isDeleted = 0"
)
public class ReceptionView implements Serializable {

    public int receptionId, totalPieces, measurementSystem, productTypeId, supplierId;
